defmodule Parteibot.HashtagControllerTest do
  ...
  # setup do
  #   twitter_account = Repo.insert! %Parteibot.TwitterAccount{name: "name", password: "password"}
  #   {:ok, conn: build_conn, twitter_account: twitter_account}
  # end
  ...
  # test "shows chosen resource", %{conn: conn, twitter_account: twitter_account} do
  #   hashtag = Repo.insert! %Hashtag{twitter_account_id: twitter_account.id}
