defmodule Parteibot.TwitterAccountControllerTest do
  ...
  test "creates resource and redirects when data is valid", %{conn: conn} do
    ...
    assert Repo.get_by(TwitterAccount, name: "twitter_name")
  end
  ...
  test "shows chosen resource", %{conn: conn} do
    twitter_account = Repo.insert!(TwitterAccount.changeset(%TwitterAccount{}, @valid_attrs))
  ...
  test "updates chosen resource and redirects when data is valid", %{conn: conn} do
    ...
    conn =
      put(conn, twitter_account_path(conn, :update, twitter_account),
        twitter_account: @valid_attrs
      )
